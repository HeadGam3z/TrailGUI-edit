			...
			for (String string : this.main.getConfig().getStringList(
				...
				if (args[0].equalsIgnoreCase("ReloadConfigs")) {
					...
					player.sendMessage(ChatColor.DARK_GRAY + "["
							+ ChatColor.RED + "TrailGUI" + ChatColor.DARK_GRAY
							+ "]: " + ChatColor.GREEN
							+ "Successfully reloaded all config files.");
					return true;
				}
				if (args[0].equalsIgnoreCase("Version")) {
					...
					player.sendMessage(ChatColor.DARK_GRAY + "["
							...
							+ ChatColor.GREEN + " created by " + ChatColor.BOLD
							+ "Coder_M, and JamieSinn" + ChatColor.GREEN + ".");
					return true;
				}
			}
		}
