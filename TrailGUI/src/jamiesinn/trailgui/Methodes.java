...
public class Methodes
{
    ...
    public static void saveTrails()
    {
        ...
        TrailData.getConfig().set("ColoredRedDust", Main.trailColoredRedDust);
    ...
    public static void openGUI1(Player player)
    {
		...
		if (checkPerms("hearts", player))
            inv1.setItem(Main.getPlugin().getConfig().getInt("Hearts-inventorySlot"), itemHearts());
        else
            inv1.setItem(Main.getPlugin().getConfig().getInt("Hearts-inventorySlot"), itemNoPerms());
        if (checkPerms("endersignal", player))
            inv1.setItem(Main.getPlugin().getConfig().getInt("EnderSignal-inventorySlot"), itemEnderSignal());
        else
            inv1.setItem(Main.getPlugin().getConfig().getInt("EnderSignal-inventorySlot"), itemNoPerms());
        if (checkPerms("iconcrack", player))
            inv1.setItem(Main.getPlugin().getConfig().getInt("IconCrack-inventorySlot"), itemIconCrack());
        else
            inv1.setItem(Main.getPlugin().getConfig().getInt("IconCrack-inventorySlot"), itemNoPerms());
        if (checkPerms("blockbreak", player))
            inv1.setItem(Main.getPlugin().getConfig().getInt("BlockBreak-inventorySlot"), itemBlockBreak());
        else
            inv1.setItem(Main.getPlugin().getConfig().getInt("BlockBreak-inventorySlot"), itemNoPerms());
...
//region Item's for Inventory Slots
    ...
    {
        ItemStack itemIconCrack = new ItemStack(Material.valueOf(Main.getPlugin().getConfig().getString("IconCrack-itemType").toUpperCase()), 1);
        ItemMeta metaIconCrack = itemIconCrack.getItemMeta();

        String name1 = Main.getPlugin().getConfig().getString("IconCrack-itemName");
        String name2 = name1.replaceAll("&", "�");
        if (Main.getPlugin().getConfig().getBoolean("IconCrack-loreEnabled"))
        {
            List<String> loreIconCrack = new ArrayList<String>();

            String loreLine1 = Main.getPlugin().getConfig().getString("IconCrack-loreLineOne").replaceAll("&", "�");
            String loreLine2 = Main.getPlugin().getConfig().getString("IconCrack-loreLineTwo").replaceAll("&", "�");
            String loreLine3 = Main.getPlugin().getConfig().getString("IconCrack-loreLineThree").replaceAll("&", "�");
    ...
    {
        ItemStack itemBlockBreak = new ItemStack(Material.valueOf(Main.getPlugin().getConfig().getString("BlockBreak-itemType").toUpperCase()), 1);
        ItemMeta metaBlockBreak = itemBlockBreak.getItemMeta();

        String name1 = Main.getPlugin().getConfig().getString("BlockBreak-itemName");
        String name2 = name1.replaceAll("&", "�");
        if (Main.getPlugin().getConfig().getBoolean("BlockBreak-loreEnabled"))
        {
            List<String> loreBlockBreak = new ArrayList<String>();

            String loreLine1 = Main.getPlugin().getConfig().getString("BlockBreak-loreLineOne").replaceAll("&", "�");
            String loreLine2 = Main.getPlugin().getConfig().getString("BlockBreak-loreLineTwo").replaceAll("&", "�");
            String loreLine3 = Main.getPlugin().getConfig().getString("BlockBreak-loreLineThree").replaceAll("&", "�");
